...
uploads={'YARDWiz-%s-OSX-10.6.dmg':{'--summary':'YARDWiz %s (OSX App)'%short_version,
         ...
         'YARDWiz-%s-linux-x64.tar.gz':{'--summary':'YARDWiz %s (Linux x64)'%short_version,
         ...
         'YARDWiz-%s-linux-x86.tar.gz':{'--summary':'YARDWiz %s (Linux x86)'%short_version,
                     '--description':'This version of YARDWiz includes a version of getWizPnP compiled for 32 bit architectures.\nInstall using "sudo python setup.py install"',
                     '--labels':'Featured,Type-Archive,OpSys-Linux'},
         'YARDWiz-%s.zip':{'--summary':'YARDWiz %s (Source)'%short_version,
                     '--description':'YARDWiz source archive',
                     '--labels':'Featured,Type-Source,OpSys-All'},
         'YARDWiz-%s-win32setup.zip':{'--summary':'YARDWiz %s (Windows installer)'%short_version,
