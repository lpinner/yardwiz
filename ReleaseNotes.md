...
### Fixed in 0.2.6 ###
  * Fixes issue with GUI becoming unresponsive when deleting ([Issue 14](http://code.google.com/p/yardwiz/issues/detail?id=14))
  * Fixes issue with GUI appearing offscreen ([Issue 15](http://code.google.com/p/yardwiz/issues/detail?id=15))
...
### Fixed in 0.2.3 ###
  * Resolved [Issue 4](https://code.google.com/p/yardwiz/issues/detail?id=4)
  * Minor tweaks and bugfixes
